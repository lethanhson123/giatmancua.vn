...
@Component({
  selector: 'app-amphieu-yeu-cau-hoan-thanh',
  templateUrl: './amphieu-yeu-cau-hoan-thanh.component.html',
  styleUrls: []
})
export class AMPhieuYeuCauHoanThanhComponent implements OnInit {
  ...
  onSubmit(form: NgForm) {
    this.aM_PhieuYeuCauService.postHoaDonDienTuHoanThanh(form.value).subscribe(
      data => {
        if (form.value.ID > 0) {
