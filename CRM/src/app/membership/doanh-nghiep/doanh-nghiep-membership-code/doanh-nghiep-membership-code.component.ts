...
@Component({
  selector: 'app-doanh-nghiep-membership-code',
  templateUrl: './doanh-nghiep-membership-code.component.html',
  styleUrls: []
})
export class DoanhNghiepMembershipCodeComponent implements OnInit {
  ...
  getToList() {
    this.membershipService.getByDoanhNghiepWithMembershipCodeIsNullToList().then(res => {
