...
@Component({
  selector: 'app-doanh-nghiep-tim-kiem',
  templateUrl: './doanh-nghiep-tim-kiem.component.html',
  styleUrls: []
})
export class DoanhNghiepTimKiemComponent implements OnInit {
  ...
  getToList() {
    ...
    this.membershipService.getDoanhNghiepByProductIDListAndCityIDAndWardIDToList(productIDList, this.cityID, this.wardID).then(res => {
  ...
  onDownloadExcelFile() {
    ...
    this.downloadService.getDoanhNghiepByProductIDListAndCityIDAndWardIDToExcelURL(productIDList, this.cityID, this.wardID).then(
      res => {
  ...
  onPrint() {
    ...
    this.downloadService.getDoanhNghiepByProductIDListAndCityIDAndWardIDToHTMLURL(productIDList, this.cityID, this.wardID).then(
      res => {
        window.open(res.toString(), "_blank");
        this.isShowLoading = false;
      }
