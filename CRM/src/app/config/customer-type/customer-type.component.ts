...
import { CustomerTypeDetailComponent } from 'src/app/config/customer-type/customer-type-detail/customer-type-detail.component';
...
export class CustomerTypeComponent implements OnInit {
  ...
  onAdd(ID: number) {
    ...
    const dialog = this.dialog.open(CustomerTypeDetailComponent, dialogConfig);
