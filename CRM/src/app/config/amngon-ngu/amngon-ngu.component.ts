...
import { AMNgonNguDetailComponent } from 'src/app/config/amngon-ngu/amngon-ngu-detail/amngon-ngu-detail.component';

@Component({
  selector: 'app-amngon-ngu',
  templateUrl: './amngon-ngu.component.html',
  styleUrls: []
})
export class AMNgonNguComponent implements OnInit {
  ...
  onAdd(ID: number) {
    ...
    const dialog = this.dialog.open(AMNgonNguDetailComponent, dialogConfig);
