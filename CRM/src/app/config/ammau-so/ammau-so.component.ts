...
import { AMMauSoDetailComponent } from 'src/app/config/ammau-so/ammau-so-detail/ammau-so-detail.component';

@Component({
  selector: 'app-ammau-so',
  templateUrl: './ammau-so.component.html',
  styleUrls: []
})
export class AMMauSoComponent implements OnInit {
  ...
  onAdd(ID: number) {
    ...
    const dialog = this.dialog.open(AMMauSoDetailComponent, dialogConfig);
