...
import { AMHeThongDetailComponent } from 'src/app/config/amhe-thong/amhe-thong-detail/amhe-thong-detail.component';

@Component({
  selector: 'app-amhe-thong',
  templateUrl: './amhe-thong.component.html',
  styleUrls: []
})
export class AMHeThongComponent implements OnInit {
  ...
  onAdd(ID: number) {
    ...
    const dialog = this.dialog.open(AMHeThongDetailComponent, dialogConfig);
