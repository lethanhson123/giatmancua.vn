...
import { NganHangDetailComponent } from 'src/app/config/ngan-hang/ngan-hang-detail/ngan-hang-detail.component';
...
export class NganHangComponent implements OnInit {
  ...
  onAdd(ID: number) {
    ...
    const dialog = this.dialog.open(NganHangDetailComponent, dialogConfig);
